...
contract BgoToken is IBEP20 {
    ...
    */
    ...
    function _setCoinDistribution() private {
        ...
        _coinDistribution["Ecosystem"][_JAN_15_2022] =  _categoriesAmountCap["Ecosystem"] * 4 / 100; // 4% TGE
        _coinDistribution["Ecosystem"][_FEB_15_2022] =  _categoriesAmountCap["Ecosystem"] * 4 / 100; // 4% Month 1
        _coinDistribution["Ecosystem"][_MAR_15_2022] =  _categoriesAmountCap["Ecosystem"] * 4 / 100; // 4% Month 2
        _coinDistribution["Ecosystem"][_APR_15_2022] =  _categoriesAmountCap["Ecosystem"] * 4 / 100; // 4% Month 3
        _coinDistribution["Ecosystem"][_MAY_15_2022] =  _categoriesAmountCap["Ecosystem"] * 4 / 100; // 4% Month 4
        _coinDistribution["Ecosystem"][_JUN_15_2022] =  _categoriesAmountCap["Ecosystem"] * 4 / 100; // 4% Month 5
        _coinDistribution["Ecosystem"][_JUL_15_2022] =  _categoriesAmountCap["Ecosystem"] * 4 / 100; // 4% Month 6
        _coinDistribution["Ecosystem"][_AUG_15_2022] =  _categoriesAmountCap["Ecosystem"] * 4 / 100; // 4% Month 7
        _coinDistribution["Ecosystem"][_SEP_15_2022] =  _categoriesAmountCap["Ecosystem"] * 4 / 100; // 4% Month 8
        _coinDistribution["Ecosystem"][_OCT_15_2022] =  _categoriesAmountCap["Ecosystem"] * 4 / 100; // 4% Month 9
        _coinDistribution["Ecosystem"][_NOV_15_2022] =  _categoriesAmountCap["Ecosystem"] * 4 / 100; // 4% Month 10
        _coinDistribution["Ecosystem"][_DEC_15_2022] =  _categoriesAmountCap["Ecosystem"] * 4 / 100; // 4% Month 11
        _coinDistribution["Ecosystem"][_JAN_15_2023] =  _categoriesAmountCap["Ecosystem"] * 4 / 100; // 4% Month 12
        _coinDistribution["Ecosystem"][_FEB_15_2023] =  _categoriesAmountCap["Ecosystem"] * 4 / 100; // 4% Month 13
        _coinDistribution["Ecosystem"][_MAR_15_2023] =  _categoriesAmountCap["Ecosystem"] * 4 / 100; // 4% Month 14
        _coinDistribution["Ecosystem"][_APR_15_2023] =  _categoriesAmountCap["Ecosystem"] * 4 / 100; // 4% Month 15
        _coinDistribution["Ecosystem"][_MAY_15_2023] =  _categoriesAmountCap["Ecosystem"] * 4 / 100; // 4% Month 16
        _coinDistribution["Ecosystem"][_JUN_15_2023] =  _categoriesAmountCap["Ecosystem"] * 4 / 100; // 4% Month 17
        _coinDistribution["Ecosystem"][_JUL_15_2023] =  _categoriesAmountCap["Ecosystem"] * 4 / 100; // 4% Month 18
        _coinDistribution["Ecosystem"][_AUG_15_2023] =  _categoriesAmountCap["Ecosystem"] * 4 / 100; // 4% Month 19
        _coinDistribution["Ecosystem"][_SEP_15_2023] =  _categoriesAmountCap["Ecosystem"] * 4 / 100; // 4% Month 20
        _coinDistribution["Ecosystem"][_OCT_15_2023] =  _categoriesAmountCap["Ecosystem"] * 4 / 100; // 4% Month 21
        _coinDistribution["Ecosystem"][_NOV_15_2023] =  _categoriesAmountCap["Ecosystem"] * 4 / 100; // 4% Month 22
        _coinDistribution["Ecosystem"][_DEC_15_2023] =  _categoriesAmountCap["Ecosystem"] * 4 / 100; // 4% Month 23
        _coinDistribution["Ecosystem"][_JAN_15_2024] =  _categoriesAmountCap["Ecosystem"] * 4 / 100; // 4% Month 24
        ...
        _coinDistribution["ShareToEarn"][_FEB_15_2023] =  _categoriesAmountCap["ShareToEarn"] * 3 / 100; // 3% Month 13
